...
// way of the future!
// ----------------------------------------
// The following dependency is from https://github.com/dave-hillier/disruptor-unity3d/blob/master/DisruptorUnity3d/Assets/RingBuffer.cs
// and Matt Coburn takes NO CREDIT for this code. Therefore the license of the dependency (if any) applies to this code.
// In short: Don't sue me, you've got better things to do with your time than be a complete jerk with lawsuits.
//
// Changes made: Rename the Disruptor3d namespace to Mirror.Ignorance.Thirdparty to prevent conflicts with other project codes.
// ----------------------------------------
...
namespace Mirror.Ignorance.Thirdparty
{
    /// <summary>
